    ...
    <View style={styles.alertRow}>
      ...
      <View style={{ flex: 1 }}>
        ...
        <Text style={styles.alertTime}>
          at {mins}:{String(secs).padStart(2, '0')}
        </Text>
      </View>
...
export default function TripDetailScreen() {
  ...
  // Try Zustand store first (instant). Fall back to AsyncStorage cache if navigated
  // directly (e.g. deep link) and store hasn't been populated yet.
  ...
  const score5 = (session.score / 20).toFixed(1);
      ...
      >
        ...
        <View style={styles.card}>
          <View style={styles.scoreRow}>
            <Text style={[styles.scoreBig, { color: scoreColor }]}>{score5}</Text>
